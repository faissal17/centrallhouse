           ...
           <div class="col-lg-3"></div>
                <div class="col-lg-6">
                    ...
                    <form action="/room/{{$rooms->id}}" method="POST" enctype="multipart/form-data">
        				 ...
        				 <input type="number" name="bed" class="form-control m-2" placeholder="number of bed" value="{{$rooms->bed}}">

        				 <input type="number" name="bath" class="form-control m-2" placeholder="number of bath" value="{{$rooms->bath}}">

        				 <input type="number" name="room" class="form-control m-2" placeholder="number of room" value="{{$rooms->room}}">
